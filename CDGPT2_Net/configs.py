...
class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('epochs_to_evaluate', 9, 'The number of epochs to train before evaluating on the test set.')
        ...
        self.define('ckpt_path_test', './checkpoints/CDGPT2/best_ckpt/',
                    'where to the best checkpoint will be evaluted. The path will be created if it does not exist.')
